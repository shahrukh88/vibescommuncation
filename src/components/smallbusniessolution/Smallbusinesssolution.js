...
<p className='sbsc1txt2mb' >A complete communications system</p>
<p className='sbsc1txt3mb' >With Vibes Communications, you get a complete phone <br/>system for small businesses that includes video and <br/>messaging capabilities.</p>
...
<p className='sbsc1txt2mb' >Stop juggling</p>
<p className='sbsc1txt3mb' >With Vibes Communications, you can finally stop<br/> juggling separate applications and get everything<br/> in one place with this easy-to-use platform.</p>



<img className='sbscc1log1'  src={sbsc1log3} alt='ecircle2'/> 
<img className='sbsccircle1c1'  src={ecircle1} alt='ecircle2'/> 
<p className='sbsc1txt2mb' >Affordable Communications Services</p>
<p className='sbsc1txt3mb' >Never miss a call and don’t compromise on quality. You can<br/> have it all with Vibes Communications as your VoIP service<br/> provider.</p>
