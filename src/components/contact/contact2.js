...
<div className='contactform2'>
    ...
    <label for="lname" className='formtext12'>LAST NAME</label><br/>
    <input type="text"  name="fname" className='inp2' id='lname'/><br/>
    <label for="fname" id='em3' className='formtext12'>E-MAIL</label><br/>
...
Texas 77056,<br/>
USA</p>
  <a href="tel:346-500-6555" className='address2' style={{marginLeft:'1%',marginTop:"-2%"}}>346-500-6555</a>
