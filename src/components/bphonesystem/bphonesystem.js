...
function Bphonesystem() {
  ...
  return (
    <div>
         <Helmet>
          <title>Business phone system Connects Teams Globally - Vibes</title>
           <meta name="description" content="A business phone system connects teams across channels and around the world, giving you access to your most important information securely, anywhere."/>
...
<div className='bpscenter3'>
   ...
   <p className='bpscenter3txt3amb'>Vibes Communications <br/>instantly transcribes<br/> calls, action items, and<br/> notes. Then sends it <br/>right to your inbox.</p>
   ...
   <p className='bpscenter3txt3bmb'>Assemble teams on a<br/> single platform and<br/> manage offices from<br/> anywhere.</p>
...
<p className='bpscenter3txt3cmb'>Move live calls between<br/> your preferred devices<br/> to stay connected <br/>while on the go.</p>
   ...
   <p className='bpscenter3txt3mb'>With our SLA of 100%<br/> uptime, you'll never<br/> have to worry about a<br/> dropped call again—<br/>just sharp quality<br/> every time.</p>
   ...
   <p className='bpscenter3txt3emb'>Choose a toll-free <br/>phone number so that <br/>customers may reach<br/> you at any time and <br/>from any location.</p>
   ...
   <p className='bpscenter3txt3dmb'>With a single click, you <br/>can transfer an <br/>incoming call to <br/>another member of <br/>your team.</p>
...
<p className='bpsclasttxt2mb'>Get a VoIP phone service that’s perfect for<br/> modern work, you can easily switch 
between<br/> devices and stay connected while on the move.</p>
